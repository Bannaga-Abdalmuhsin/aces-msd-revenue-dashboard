...
export function CardGridSkeleton({ count = 8 }: { count?: number }) {
  return (
    <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4" data-testid="skeleton-cards">
...
export function ChartSkeleton({ height = 300 }: { height?: number }) {
  return (
    <div
      className="flex w-full items-end gap-2 rounded-lg border border-card-border bg-card p-4"
      style={{ height }}
